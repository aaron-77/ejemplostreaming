...
var bd_1 = require("./bd");
var ArtistasManagerBd = /** @class */ (function () {
    function ArtistasManagerBd() {
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        fehaDeNacimeinto = req.body.fehaDeNacimeinto;
                        web = req.body.web;
    ...
    ArtistasManagerBd.prototype.actualizar = function (req, res) {
        console.log("artista actualizado exitosmente");
    };
    ArtistasManagerBd.prototype.eliminar = function (req, res) {
        console.log("artista eliminado exitosamente");
    };
    return ArtistasManagerBd;
}());
