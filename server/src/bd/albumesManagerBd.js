...
var bd_1 = require("./bd");
var AlbumesManagerBd = /** @class */ (function () {
    function AlbumesManagerBd() {
    }
    AlbumesManagerBd.prototype.crear = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var fkArtista, titulo, duracion, numeroDeTracks, compañiaProductora, tipoDeAlbum, fechaDeLanzamiento, urlDePortada, album, canciones;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fkArtista = req.body.fkArtista;
                        titulo = req.body.titulo;
                        duracion = req.body.duracion;
                        numeroDeTracks = req.body.numeroDeTracks;
                        compañiaProductora = req.body.compañiaProductora;
                        tipoDeAlbum = req.body.tipoDeAlbum;
                        fechaDeLanzamiento = req.body.fechaDeLanzamiento;
                        urlDePortada = req.body.urlDePortada;
                        album = {
                            fkArtista: fkArtista,
                            titulo: titulo,
                            duracion: duracion,
                    ...
                    case 1:
                        (_a.sent()).query('INSERT INTO albumes set ?', [album]);
    ...
    AlbumesManagerBd.prototype.actualizar = function (req, res) {
        console.log("album actualizado exitosmente");
    };
    AlbumesManagerBd.prototype.eliminar = function (req, res) {
        console.log("album eliminado exitosamente");
    };
    return AlbumesManagerBd;
}());
